...
$id=$_GET['s_id'];
$sel="SELECT * FROM student_lms WHERE s_id='$id'";
$sssrun=mysqli_query($conn,$sel);
$sssfet=mysqli_fetch_array($sssrun);
...
if(isset($_POST['sub'])){
  ...
  $qury="UPDATE student_lms SET s_ses='$session',t_name='$tname',ref='$ref',s_date='$s_date',`name`='$name',fname='$fname',email='$email',phno='$phone',sgen='$gen',dob='$dob',s_status='$s_status',s_add='$add',img='$img',t_deg='$tdeg',d_name='$degname',deg_status='$deg_sta',uni='$uni',`year`='$year',t_fee='$t_fee',pay_method='$pay',paid_fee='$paid',rem_fee='$rem',pay_term='$term'";
              ...
              <a href="viewstudent.php" class="btn btn-info" style="float:right">View</a>
                ...
                <div class="form-group col-lg-4 col-md-6 col-sm-6">
                    ...
                    <div class="form-group col-lg-12 col-md-12 col-sm-12">
                      <label>Address</label>
                      <textarea name="sadd" class="form-control"></textarea>
                    </div>
                  ...
                  <div class="form-group col-lg-4 col-md-6 col-sm-6">
                    ...
                    <div class="form-group col-lg-4 col-md-6 col-sm-6">
                      ...
                      <input type="text" name="tfee"  class="form-control">
                    </div>
